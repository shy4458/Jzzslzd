...
public class Sjcx_Activity extends Activity implements OnScrollListener {
	private ProgressDialog dialog;
	private PhoneSjcxcy sjcxcy;
	private SharedPreferences preferences;
	private String result, result1, sjbh;
	private int lastItem, page = 0, totalPage, index = 0;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.sjcx_a);
		footerView = View
				.inflate(Sjcx_Activity.this, R.layout.footerview, null);
		lv = (ListView) findViewById(R.id.sjcx_listView);
		list = new ArrayList<Map<String, String>>();
		adapter = new SimpleAdapter(Sjcx_Activity.this, list,
	...
	private Handler handler = new Handler() {
		public void handleMessage(Message msg) {
			...
			case 1:
				...
				break;
			case 2:
				StaticObject.showToast(Sjcx_Activity.this, "市级接口连接失败");
				break;

			case 404:
				StaticObject.showToast(Sjcx_Activity.this, "网络连接失败");
				break;
			default:
				break;
			}
	...
	private Handler handler1 = new Handler() {
		public void handleMessage(Message msg) {
			switch (msg.what) {
			case 1:
				Intent intent = new Intent(Sjcx_Activity.this,
						Sjxq_Activity.class);
				Bundle bundle = msg.getData();
			...
			case 2:
				...
				break;
			case 3:
				StaticObject.showToast(Sjcx_Activity.this, msg.obj.toString());
				break;
			case 404:
				StaticObject.showToast(Sjcx_Activity.this, "网络连接失败");
				break;
	...
	private void getData() {
		preferences = Sjcx_Activity.this.getSharedPreferences(
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				result = StaticObject.getMessage(Sjcx_Activity.this,
	...
	private void getData1(final String sjbh) {
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				result1 = StaticObject.getMessage(Sjcx_Activity.this,
	...
	public void onScrollStateChanged(AbsListView view, int scrollState) {
		if (lastItem == list.size()
			...
			getData();
				...
				&& page <= totalPage) {
			// 最后一页 下拉提示到底了
			StaticObject.showToast(Sjcx_Activity.this, "已显示全部数据");
			footerView.setVisibility(View.GONE);
		}
	}
